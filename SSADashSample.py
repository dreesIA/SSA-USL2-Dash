...
def render_comparative_analysis(df_daily, api_key):
    ...
    display_ai_assistant("Player Comparison Analysis", comparison_summary, api_def generate_enhanced_match_summary(df_events):
...
def render_weekly_training_report(api_key):
    ...
    # View mode selection
    view_mode = st.sidebar.radio(# VERY IMPORTANT
